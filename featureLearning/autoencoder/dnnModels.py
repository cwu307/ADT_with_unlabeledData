...
def createAeModel(inputDim, inputDim2, embedDim, selectedOptimizer, selectedLoss):
    ...
    out3 = Convolution2D(16, (3, 3), activation='relu', padding='same', data_format='channels_first', kernel_initializer=fixed_init)(out2) #16 x 32 x 128
    out3 = BatchNormalization()(out3)
    out3 = MaxPooling2D((2, 1), padding='same', data_format='channels_first')(out3)  #16 x 16 x 128
    out4 = Convolution2D(16, (3, 3), activation='relu', padding='same', data_format='channels_first', kernel_initializer=fixed_init)(out3) #16 x 16 x 128
    out4 = BatchNormalization()(out4)
    out4 = MaxPooling2D((2, 1), padding='same', data_format='channels_first')(out4)  #16 x 8 x 128

    encoded = Convolution2D(embedDim, (1, 1), activation='relu', padding='same', data_format='channels_first', kernel_initializer=fixed_init)(out4) #embedDim x 8 x 128
